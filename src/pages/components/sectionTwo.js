          ...
          <GridComponent columns={2}>
            ...
            <GridItem w='100%' h='100%'>
              <Stack>
                ...
                <Text fontSize={"1.25rem"}>I love to be creative and watch my ideas come to life. That&aposs why I am looking to learn as much as I can about AI, while trying to make a positive impact on the world. Even, if it&apos;s a small impact!</Text>
            ...
            <GridItem w='100%' h='100%'>
              <Stack>
                ...
                <Text fontSize={"1.25rem"}>I am passionate about building software, and learning how to use AI and software to revolutionize the everyday person&aposs life.</Text>
